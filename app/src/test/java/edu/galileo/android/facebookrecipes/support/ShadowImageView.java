...
public class ShadowImageView extends ShadowView {
    ...
    public void perfomSwipe(float xStar, float yStart, float xEnd, float yEnd, long duration){
        long downTime = 0;
        long moveTime = downTime + duration / 2;
        long upTime = downTime + duration;

        realImageView.dispatchTouchEvent(MotionEvent.obtain(downTime, downTime, MotionEvent.ACTION_DOWN, xStar, yStart, 0));
